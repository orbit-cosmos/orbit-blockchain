...
import (
	...
	"github.com/orbit-cosmos/orbit-blockchain/crypto/signify"
	"github.com/orbit-cosmos/orbit-blockchain/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/orbit-cosmos/orbit-blockchain/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/orbit-cosmos/orbit-blockchain/internal/version.gitDate="+env.Date)
	}
