...
import (
	...
	"github.com/orbit-cosmos/orbit-blockchain/console/prompt"
	"github.com/orbit-cosmos/orbit-blockchain/eth"
	"github.com/orbit-cosmos/orbit-blockchain/eth/downloader"
	"github.com/orbit-cosmos/orbit-blockchain/ethclient"
	...
	_ "github.com/orbit-cosmos/orbit-blockchain/eth/tracers/js"
	_ "github.com/orbit-cosmos/orbit-blockchain/eth/tracers/native"
...
func prepare(ctx *cli.Context) {
	...
	case ctx.IsSet(utils.OrbitTestnetFlag.Name):
		log.Info("Starting Geth on Testnet...")

	case ctx.IsSet(utils.OrbitMainnetFlag.Name):
		log.Info("Starting Geth on Testnet...")
...
`)
	...
	if ctx.String(utils.SyncModeFlag.Name) != "light" && !ctx.IsSet(utils.CacheFlag.Name) && !ctx.IsSet(utils.NetworkIdFlag.Name) {
		...
		if !ctx.IsSet(utils.HoleskyFlag.Name) &&
			...
			!ctx.IsSet(utils.OrbitTestnetFlag.Name) &&
			!ctx.IsSet(utils.OrbitMainnetFlag.Name) &&
